...
import { Languages, GraduationCap, Users, EarOff, Newspaper, Briefcase, BookOpenText, TvMinimalPlay, Plane, Menu } from 'lucide-react';
...
const menuItems = [
    ...
    { id: "culture", title: "Culture", text: "Découvrez la richesse de la culture sourde.", icon: BookOpenText, href: ROUTES.DEAF_CULTURE },
    { id: "socialDashboard", title: "Social", text: "Découvrez les événements et activités communautaires.", icon: Users, href: ROUTES.SOCIAL },
    { id: "facilities", title: "Accessibilité", text: "Trouvez des lieux accessibles en LSF.", icon: EarOff, href: ROUTES.FACILITIES },
...
const CardsPage = () => {
    ...
    // Gestion du survol pour ouvrir/fermer la sidebar (desktop uniquement)
