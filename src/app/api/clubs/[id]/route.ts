...
export async function GET(
    ...
    try {
        ...
        // Log de l'opération
        logPostOperation('GET', undefined, user.id, clubId, {
            searchOptions,
...
export async function POST(
    ...
    try {
        ...
        try {
            ...
            logPostOperation('CREATE', undefined, user.id, clubId, {
        ...
        const result = await postService.createPost(clubId, user, requestBody);
        ...
        // Log de succès
        logPostOperation('CREATE', result.data!.id, user.id, clubId, {
