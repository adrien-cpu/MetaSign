...
export interface FragmentationAnalysisParams {
    /** Taille du tas utilisée (bytes) */
    heapUsed: number;
    /** Taille totale du tas (bytes) */
    heapTotal: number;
    /** Échantillons historiques pour l'analyse */
    samples: MemoryMetrics[];
}

// Import nécessaire pour FragmentationAnalysisParams
import { MemoryMetrics } from './memory.types';