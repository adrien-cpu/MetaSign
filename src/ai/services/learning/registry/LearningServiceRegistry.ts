...
export class LearningServiceRegistry {
     ...
     * 
     * @method resetServiceRecoveryState
     * @param {string} serviceId - Identifiant du service
     * @public
     */
    public resetServiceRecoveryState(serviceId: string): void {
        this.recoveryManager.resetRecoveryState(serviceId);
    }

    /**
     * Obtient le gestionnaire de récupération
     * Cette méthode permet un accès limité au gestionnaire de récupération
     * 
     * @method getRecoveryManager
     * @returns {RecoveryManager} Gestionnaire de récupération
     * @public
     */
